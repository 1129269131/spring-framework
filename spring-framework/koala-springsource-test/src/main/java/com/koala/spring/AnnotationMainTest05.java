...
import com.koala.spring.bean.Person03;
 ...
 */
public class AnnotationMainTest05 {
	...
	public static void main(String[] args) {
		...
		Person03 bean3 = applicationContext.getBean(Person03.class);
		Cat02 cat1 = bean3.getCat();

		Person03 bean4 = applicationContext.getBean(Person03.class);
